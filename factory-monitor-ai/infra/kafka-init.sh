...
/opt/kafka/bin/kafka-topics.sh --bootstrap-server "${BOOTSTRAP}"   --create --if-not-exists   --topic vision.heatmap.v1   --partitions 6 --replication-factor 1   --config cleanup.policy=delete   --config retention.ms=86400000
